...
public class Ejercicio2_6 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("¿Fue insertado el nuevo proyecto? " + res);
        ...
        boolean aumento = db.aumentarSalario(1,200);
        System.out.println("¿Fue aumentado el salario? " + aumento);
        ...
        int numProxectos = 1;
        db.mostrarPersonalizado(numProxectos);
    }
}
